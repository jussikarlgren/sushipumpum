...
m=1;
n=000$m;
source="/var/www/html/corpora-export/de-split/SDA*$k*html"
#source="/var/www/html/corpora-export/de-lemma/SDA*$k*html"
while test -a $source;  do
#echo $source;
# cstlemma filen
/home/jussi/Tvarsok/cstlemma -B'$w' -c '$B$s' -f /home/jussi/Tvarsok/flexrulesC1  -t- < $source > $target
#bzip2 $source;
#bzip2 $target;
(( m++ ));
