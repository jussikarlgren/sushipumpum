#==============================================================================================================================
# samlar ihop på ssyk3-koder för individer så att fall som är senare ska få samma som tidigare angivet yrke ifall något saknas
...
while (<>) {
    ...
    print "$index $ssyk3{$index}";
    if ($prevss && $prevss ne $ssyk3{$index}) {print "<- $prevss";}
    print "\n";
}
